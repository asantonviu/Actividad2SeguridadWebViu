...
### Actividad enfocada al uso de Laravel Sanctum donde:
  ...
  En caso de ir todo en orden, se devolverá un codigo http 200 con una respuesta similara a:  
    ...
    ```  
  donde va el token a utilizar en el resto de llamadas.  
...
***IMPORTANTE***  
Para el correcto funcionamiento de las llamadas a las API, es necesario que en las cabeceras de la peticion esté la cabecera:  
